...
for line in inp:
    ...
    if (style > 0):
        print (style, "fehlende(r) [/style] Tag in Abschnit ", zeile, ": ", a[0:35], "...\n")
    if (style <0):
        print (style*-1, " [/style] Tag(s) zu viel in Abschnit ", zeile, ": ", a[0:35], "...\n")
    align = a.count("??l")+ a.count("??r") + a.count("??c") - a.count("/??")
    if (align > 0):
        print (align, " fehlende(r) [/align] Tag in Abschnit ", zeile, ": ", a[0:35], "...\n")
    if (align < 0):
        print (align*-1, " [/align] Tag(s) zu viel in Abschnit ", zeile, ": ", a[0:35], "...\n")
